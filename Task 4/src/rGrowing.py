...
class RegionGrowing():
    ...
    def __init__(self,imgPath:str,threshold:int,savePath:str):
...
if __name__ == "__main__":    
    ...
    def RGWrapper(filename:str,threshold:int,savePath:str):
        test = RegionGrowing(fileName,threshold,savePath)
        test.RegionGrow()
    ...
    fileName = "./2coins.png"
    saveFile = "./2coins-out.png"
    threshold = 15
    RGWrapper(fileName,threshold,saveFile)
    
    # test = RegionGrowing(fileName,threshold,saveFile)
    # test.RegionGrow()
